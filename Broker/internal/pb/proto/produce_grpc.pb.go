...
type PublisherClient interface {
	ProduceMessage(ctx context.Context, in *ProduceRequest, opts ...grpc.CallOption) (*ProduceReply, error)
}
...
func (c *publisherClient) ProduceMessage(ctx context.Context, in *ProduceRequest, opts ...grpc.CallOption) (*ProduceReply, error) {
	out := new(ProduceReply)
	err := c.cc.Invoke(ctx, "/GrpcAgent.Publisher/ProduceMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PublisherServer interface {
	ProduceMessage(context.Context, *ProduceRequest) (*ProduceReply, error)
...
func (UnimplementedPublisherServer) ProduceMessage(context.Context, *ProduceRequest) (*ProduceReply, error) {
...
func _Publisher_ProduceMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProduceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PublisherServer).ProduceMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/GrpcAgent.Publisher/ProduceMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PublisherServer).ProduceMessage(ctx, req.(*ProduceRequest))
	}
...
var Publisher_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "GrpcAgent.Publisher",
	HandlerType: (*PublisherServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "ProduceMessage",
			Handler:    _Publisher_ProduceMessage_Handler,
		},
	},
